package com.codebridge.docker.security;
...
/**
 * Security configuration for the Docker Management service.
...
public class DockerSecurityConfig {
    ...
    public JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        converter.setJwtGrantedAuthoritiesConverter(new DockerRoleConverter());
        return converter;
    }
}
