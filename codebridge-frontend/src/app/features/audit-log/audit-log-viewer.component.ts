...
import { CommonModule, DatePipe, JsonPipe } from '@angular/common'; // Added JsonPipe
...
@Component({
  ...
  standalone: true,
  imports: [
    CommonModule, RouterModule, ReactiveFormsModule, DatePipe, JsonPipe, // Added JsonPipe
